...
export function SummaryLab({api,getKey,getGeminiKey,renderHtml,pickFromICloud}){
 ...
 <div className={reading?'layout':'layout idle'}><aside>
 {!showComposer&&<section className="panel"><h2 style={{marginBottom:10}}>Add a source</h2><p className="muted" style={{marginTop:0}}>Start a second experiment from another source whenever you want to compare.</p><button className="primary" style={{marginTop:14}} onClick={()=>setComposerOpen(true)}>New experiment</button></section>}
