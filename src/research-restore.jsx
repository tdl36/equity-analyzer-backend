...
export function ResearchRestore({api,record,onClose,onRestored}) {
  ...
  return <section className="workspace-panel research-restoration" aria-label="Restore a historical research version"><div className="workspace-section-heading"><div><p className="workspace-eyebrow">VERSION RESTORATION</p><h3>Review before restoring.</h3></div><button disabled={busy||uncertain} onClick={onClose}>Close preview</button></div>
