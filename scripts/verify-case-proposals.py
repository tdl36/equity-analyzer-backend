...
def model(prompt,key,tokens):
 ...
 if tokens==5000:
  ...
  return {'checks':[{'id':'0','verdict':'pass','issue':''}]}
 ...
 return {'changes':[{'path':f'assumptions.{aid}.support','after':excerpt,'reason':'Updated guidance','source_id':sources[0]['id'],'source_excerpt':excerpt}]}
try:
