...
export function ResearchChat({
  ...
  var panel = /*#__PURE__*/React.createElement("section", {
    ...
    className: "desk-explainer"
  }, "Company context at reply: ", m.memoryReceipt?.length ? m.memoryReceipt.map(e => e.kind === 'investment_case' ? `investment case v${e.revision}` : e.kind === 'analyst_decision' ? `decision #${e.revision}` : 'legacy thesis').join(' · ') : 'no saved case or thesis', m.frameworkRevision ? ` · framework v${m.frameworkRevision}` : '', ". Sources not reverified."))) : /*#__PURE__*/React.createElement("p", {
