...
export function AssignmentWorkspace({
  ...
  }, /*#__PURE__*/React.createElement("summary", null, "Full assignment and focus areas"), /*#__PURE__*/React.createElement("p", null, data.assignment.instruction)), /*#__PURE__*/React.createElement("p", null, data.assignment.since, " through ", data.assignment.until), /*#__PURE__*/React.createElement("ol", null, /*#__PURE__*/React.createElement("li", null, "Command: ", data.command.status), /*#__PURE__*/React.createElement("li", null, "Collection: ", data.sourceReuse ? 'Verified saved sources · no new search' : data.collection?.status || 'awaiting Mac snapshot'), /*#__PURE__*/React.createElement("li", null, "Preparation: ", data.preparation?.status || 'not started', " \xB7 ", data.preparation?.stage || 'waiting for verified sources')), (data.collection?.issue || data.preparation?.error || data.command.error) && /*#__PURE__*/React.createElement("p", {
    role: "alert"
