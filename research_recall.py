...
def terms_for(case):
    ...
    body=obj(body)
    texts=[body.get('thesis',''),body.get('variantView',''),body.get('changeConditions','')]
...
def retrieve(cur,ticker,case,recent,as_of):
    terms,limited=terms_for(case)
    ...
    return selected,{'method':'literal_case_terms','terms':terms,'termsLimited':limited,
