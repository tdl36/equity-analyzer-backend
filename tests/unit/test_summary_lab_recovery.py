...
import anthropic
import httpx
from summary_lab import ask_with_recovery, ProviderFailure
...
class RecoveryTests(unittest.TestCase):
 ...
 def test_overload_exhaustion_is_bounded_and_clear(self):
  ...
  with self.assertRaisesRegex(ProviderFailure,'temporarily overloaded'):call()
 ...
 def test_auth_is_not_retried(self):
  ...
  with self.assertRaisesRegex(ProviderFailure,'Settings'):call()
